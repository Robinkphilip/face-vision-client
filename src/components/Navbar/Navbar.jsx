...
export default function Navbar() {
  return (
    <nav className="bg-blue-900 rounded-lg mt-4 ml-4 mr-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <a href="/" className="flex items-center">
            ...
            <span className="self-center text-lg font-semibold whitespace-nowrap text-blue-200 ">FaceVision</span>
          </a>
          <div className="hidden md:block">
            <div className="ml-4 flex items-center"></div>
          </div>
          <div className="flex items-center ">
            <a href="/auth" className= "text-blue-900  hover:text-gray-900 px-6 py-2 rounded-md text-sm  font-bold bg-blue-200 ">Logout</a>
          </div>
        </div>
      </div>
    </nav>
